...
<div class="art-Logo">
 <h1 id="name-text" class="art-Logo-name"><a href="<?php echo $baseUrl; ?>/">SELENA VILLAGE</a></h1>
 <div id="HOTEL" class="art-Logo-text">HOTEL</div>
</div>
...
<div class="cleared"></div>
<p class="art-page-footer">Designed by <a href="http://www.gamingguide.net" target="_blank">Ashaba Isabella</a></p>
</div>
